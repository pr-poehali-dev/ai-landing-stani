...
export function CTASection() {
  ...
  return (
    <section id="contact" className="py-12 sm:py-24 px-4 sm:px-6 bg-gradient-to-br from-primary/20 via-secondary/20 to-background relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-4xl relative z-10">
        ...
        <Card className="glass-card p-5 sm:p-8 max-w-2xl mx-auto">
          {sent ? (
